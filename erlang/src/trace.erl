...
trace(f18A,?EX,CPU) ->
   trace:trace(f18A,{ CPU#cpu.id,{ex,{p,CPU#cpu.p}}});
...
trace(f18A,?UNEXT,CPU) ->
   trace:trace(f18A,{ CPU#cpu.id,{unext,{r,CPU#cpu.r},{i,CPU#cpu.i}}});
...
trace(f18A,?FETCH_PLUS,CPU) ->
   trace:trace(f18A,{ CPU#cpu.id,{fetch_plus,{p,CPU#cpu.p},{t,CPU#cpu.t}}});
