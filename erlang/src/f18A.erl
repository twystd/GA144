...
% TODO extended arithmetic/carry
-define(TEST_MULTIPLY,[{?MULTIPLY,[{a,0},{t,0}],[{a,16#00000},{t,0}]},
                       {?MULTIPLY,[{a,0},{t,1}],[{a,16#20000},{t,0}]},
                       {?MULTIPLY,[{a,0},{t,2}],[{a,16#00000},{t,1}]},
                       {?MULTIPLY,[{a,0},{t,16#20000}],[{a,16#00000},{t,16#30000}]},
                       {?MULTIPLY,[{a,0},{t,16#20001}],[{a,16#20000},{t,16#30000}]},
                       {?MULTIPLY,[{a,0},{t,16#20002}],[{a,16#00000},{t,16#30001}]},

                       {?MULTIPLY,[{a,2},{t,0}],[{a,16#00001},{t,0}]},
                       {?MULTIPLY,[{a,2},{t,1}],[{a,16#20001},{t,0}]},
                       {?MULTIPLY,[{a,2},{t,2}],[{a,16#00001},{t,1}]},
                       {?MULTIPLY,[{a,2},{t,16#20000}],[{a,16#00001},{t,16#30000}]},
                       {?MULTIPLY,[{a,2},{t,16#20001}],[{a,16#20001},{t,16#30000}]},
                       {?MULTIPLY,[{a,2},{t,16#20002}],[{a,16#00001},{t,16#30001}]},

                       {?MULTIPLY,[{a,1},{t,0},       {s,0}],[{a,16#00000},{t,0},       {s,0}]},
                       {?MULTIPLY,[{a,1},{t,1},       {s,0}],[{a,16#20000},{t,0},       {s,0}]},
                       {?MULTIPLY,[{a,1},{t,2},       {s,0}],[{a,16#00000},{t,1},       {s,0}]},

                       {?MULTIPLY,[{a,1},{t,0},       {s,1}],[{a,16#20000},{t,0},       {s,1}]},
                       {?MULTIPLY,[{a,1},{t,1},       {s,1}],[{a,16#00000},{t,1},       {s,1}]},
                       {?MULTIPLY,[{a,1},{t,2},       {s,1}],[{a,16#20000},{t,1},       {s,1}]},

                       {?MULTIPLY,[{a,1},{t,0},       {s,2}],[{a,16#00000},{t,1},       {s,2}]},
                       {?MULTIPLY,[{a,1},{t,1},       {s,2}],[{a,16#20000},{t,1},       {s,2}]},
                       {?MULTIPLY,[{a,1},{t,2},       {s,2}],[{a,16#00000},{t,2},       {s,2}]},

                       {?MULTIPLY,[{a,1},{t,16#20000},{s,0}],[{a,16#00000},{t,16#30000},{s,0}]},
                       {?MULTIPLY,[{a,1},{t,16#20001},{s,0}],[{a,16#20000},{t,16#30000},{s,0}]},
                       {?MULTIPLY,[{a,1},{t,16#20002},{s,0}],[{a,16#00000},{t,16#30001},{s,0}]},

                       {?MULTIPLY,[{a,1},{t,16#20000},{s,1}],[{a,16#20000},{t,16#30000},{s,1}]},
                       {?MULTIPLY,[{a,1},{t,16#20001},{s,1}],[{a,16#00000},{t,16#30001},{s,1}]},
                       {?MULTIPLY,[{a,1},{t,16#20002},{s,1}],[{a,16#20000},{t,16#30001},{s,1}]},

                       {?MULTIPLY,[{a,1},{t,16#20000},{s,2}],[{a,16#00000},{t,16#30001},{s,2}]},
                       {?MULTIPLY,[{a,1},{t,16#20001},{s,2}],[{a,16#20000},{t,16#30001},{s,2}]},
                       {?MULTIPLY,[{a,1},{t,16#20002},{s,2}],[{a,16#00000},{t,16#30002},{s,2}]},

                       {?MULTIPLY,[{a,3},{t,0},       {s,0}],[{a,16#00001},{t,0},       {s,0}]},
                       {?MULTIPLY,[{a,3},{t,1},       {s,0}],[{a,16#20001},{t,0},       {s,0}]},
                       {?MULTIPLY,[{a,3},{t,2},       {s,0}],[{a,16#00001},{t,1},       {s,0}]},

                       {?MULTIPLY,[{a,3},{t,0},       {s,1}],[{a,16#20001},{t,0},       {s,1}]},
                       {?MULTIPLY,[{a,3},{t,1},       {s,1}],[{a,16#00001},{t,1},       {s,1}]},
                       {?MULTIPLY,[{a,3},{t,2},       {s,1}],[{a,16#20001},{t,1},       {s,1}]},

                       {?MULTIPLY,[{a,3},{t,0},       {s,2}],[{a,16#00001},{t,1},       {s,2}]},
                       {?MULTIPLY,[{a,3},{t,1},       {s,2}],[{a,16#20001},{t,1},       {s,2}]},
                       {?MULTIPLY,[{a,3},{t,2},       {s,2}],[{a,16#00001},{t,2},       {s,2}]},

                       {?MULTIPLY,[{a,3},{t,16#20000},{s,0}],[{a,16#00001},{t,16#30000},{s,0}]},
                       {?MULTIPLY,[{a,3},{t,16#20001},{s,0}],[{a,16#20001},{t,16#30000},{s,0}]},
                       {?MULTIPLY,[{a,3},{t,16#20002},{s,0}],[{a,16#00001},{t,16#30001},{s,0}]},

                       {?MULTIPLY,[{a,3},{t,16#20000},{s,1}],[{a,16#20001},{t,16#30000},{s,1}]},
                       {?MULTIPLY,[{a,3},{t,16#20001},{s,1}],[{a,16#00001},{t,16#30001},{s,1}]},
                       {?MULTIPLY,[{a,3},{t,16#20002},{s,1}],[{a,16#20001},{t,16#30001},{s,1}]},

                       {?MULTIPLY,[{a,3},{t,16#20000},{s,2}],[{a,16#00001},{t,16#30001},{s,2}]},
                       {?MULTIPLY,[{a,3},{t,16#20001},{s,2}],[{a,16#20001},{t,16#30001},{s,2}]},
                       {?MULTIPLY,[{a,3},{t,16#20002},{s,2}],[{a,16#00001},{t,16#30002},{s,2}]},

                       {?MULTIPLY,[{a,1},{t,16#20000},{s,16#20000}],[{a,16#00000},{t,16#20000},{s,16#20000}]},
                       {?MULTIPLY,[{a,1},{t,16#20001},{s,16#20000}],[{a,16#20000},{t,16#20000},{s,16#20000}]},
                       {?MULTIPLY,[{a,1},{t,16#20002},{s,16#20000}],[{a,16#00000},{t,16#20001},{s,16#20000}]},

                       {?MULTIPLY,[{a,1},{t,16#20000},{s,16#20001}],[{a,16#20000},{t,16#20000},{s,16#20001}]},
                       {?MULTIPLY,[{a,1},{t,16#20001},{s,16#20001}],[{a,16#00000},{t,16#20001},{s,16#20001}]},
                       {?MULTIPLY,[{a,1},{t,16#20002},{s,16#20001}],[{a,16#20000},{t,16#20001},{s,16#20001}]},

                       {?MULTIPLY,[{a,1},{t,16#20000},{s,16#20002}],[{a,16#00000},{t,16#20001},{s,16#20002}]},
                       {?MULTIPLY,[{a,1},{t,16#20001},{s,16#20002}],[{a,16#20000},{t,16#20001},{s,16#20002}]},
                       {?MULTIPLY,[{a,1},{t,16#20002},{s,16#20002}],[{a,16#00000},{t,16#20002},{s,16#20002}]},

                       {?MULTIPLY,[{a,3},{t,16#20000},{s,16#20000}],[{a,16#00001},{t,16#20000},{s,16#20000}]},
                       {?MULTIPLY,[{a,3},{t,16#20001},{s,16#20000}],[{a,16#20001},{t,16#20000},{s,16#20000}]},
                       {?MULTIPLY,[{a,3},{t,16#20002},{s,16#20000}],[{a,16#00001},{t,16#20001},{s,16#20000}]},

                       {?MULTIPLY,[{a,3},{t,16#20000},{s,16#20001}],[{a,16#20001},{t,16#20000},{s,16#20001}]},
                       {?MULTIPLY,[{a,3},{t,16#20001},{s,16#20001}],[{a,16#00001},{t,16#20001},{s,16#20001}]},
                       {?MULTIPLY,[{a,3},{t,16#20002},{s,16#20001}],[{a,16#20001},{t,16#20001},{s,16#20001}]},

                       {?MULTIPLY,[{a,3},{t,16#20000},{s,16#20002}],[{a,16#00001},{t,16#20001},{s,16#20002}]},
                       {?MULTIPLY,[{a,3},{t,16#20001},{s,16#20002}],[{a,16#20001},{t,16#20001},{s,16#20002}]},
                       {?MULTIPLY,[{a,3},{t,16#20002},{s,16#20002}],[{a,16#00001},{t,16#20002},{s,16#20002}]}
                      ]).
